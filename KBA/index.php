                        ...
                        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                            ...
                            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                                ...
                                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 pe-5">
                                    <li class="nav-item active">
                                        <a class="nav-link" href="https://kenyabodaboda.co.ke/">KBA</a>
                                    </li>
                                </ul>

                                <a class="navbar-brand" href="https://kenyabodaboda.co.ke/">
                                    <img src="images/partners/KBA.png" class="ms-3" id="mainNavLogo">
                                </a>
                            </div>
                        </nav>
                    </div>
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                                <form action="register.php" method="POST" id="registrationForm" role="form" accept-charset="UTF-8">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <!-- Member Number -->
                                                        <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4 p-3">
                                                            <label for="member_number" class="form-label"><b class="text-uppercase">KBA Member Number:</b></label>
